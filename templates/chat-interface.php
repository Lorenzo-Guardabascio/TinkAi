    ...
    <div class="container" style="height: <?php echo esc_attr($height); ?>;">
        <header>
            ...
            <div class="header-actions">
                ...
                <button id="theme-toggle" class="theme-toggle" title="Cambia tema" aria-label="Toggle dark mode">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="sun-icon" d="M12 17C14.7614 17 17 14.7614 17 12C9.23858 14.7614 7 12 7C9.23858 7 7 9.23858 17 12 17Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
